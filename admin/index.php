...
<head>
	...
	<title>پیش سفر  | ورود مدیریت</title>
...
<body>
			...
			<div class="container" >
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a style="background-color: #7FDBFF;color: black" href="http://localhost/shopping_php/">
						بازگشت به پیش سفر
						...
						<div class="module-foot">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-primary pull-right" name="submit">وارد شدن</button>
	...
	<div class="footer" style="background-color: #0a1517;" >
		<div class="container"  dir="rtl" align="right">
			 

			<b class="copyright">&copy; پیش سفر  </b> کلیه حقوق محفوظ است
		</div>
	</div>
